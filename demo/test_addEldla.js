...
async function test_addEldla() {
    ...
    add_eldla_param={
        certid    : "352624197503164611",
        name      : "刘文华",
        relation  : "儿子",
	    elder_id  : "et2tQt2G", //王网,1950年出生的一个老婆婆诈骗犯
    }

    add_eldla_param={
        certid    : "452628198612042713",
        name      : "刘祥安",
        relation  : "儿子",
	    elder_id  : "et2tQt2G", //王网,1950年出生的一个老婆婆诈骗犯
    }
    ...
    res = await dua.addEldla(add_eldla_param)
    console.log(res);
    if(res.error == 0){
